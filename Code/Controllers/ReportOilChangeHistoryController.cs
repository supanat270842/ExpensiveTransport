...
[Authorize]
public class ReportOilChangeHistoryController : BaseController
{
    private readonly INotyfService _notyfService;
    ApplicationOilStationContext _db;

    public ReportOilChangeHistoryController(INotyfService notyfService, ApplicationOilStationContext db)
    {
        _db = db;
